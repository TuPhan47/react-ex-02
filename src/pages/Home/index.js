		...
		<div id="l-main__wrp">
			<section className="main-visual section">
				...
				<div className="main-visual__avatar">
					<figure>
						<img src={require('~/assets/images/avatar.jpg').default} alt="" className="fluid-image" />
					</figure>
				</div>
			</section>

			<section className="box-skills section">
				<div className="wrp-container">
					<div className="grid-row box-skills-wrp">
						<div className="grid-col--6 box-skills__item">
							...
							<p className="txt-base">
								I like to craft solid and scalable frontend products with great user experiences. I like
								to craft solid and scalable frontend products with great user experiences.
							</p>
						</div>
						<div className="grid-col--6 box-skills__item">
							<h3 className="hdg hdg-lv3">Design</h3>
				...
				<div className="box-about__inner">
					...
					<div className="box-about__content">
						...
						<p className="box-about__des txt-base">
							I like to craft solid and scalable frontend products with great user experiences. I like to
							craft solid and scalable frontend products with great user experiences. I like to craft
							solid and scalable frontend products with great user experiences. I like to craft solid and
			...
			<section className="box-exp wrp-container-fluid section">
						...
						<tbody>
							<tr>
								...
								<td>
									...
									user experiences. I like to craft solid and scalable frontend products <br />
